...
const Themetrigger = () => {
    ...
    const [theme, setTheme] = useState(localStorage.getItem('theme')=='dark' ? window.document.documentElement.classList.add('dark') : false)
